...
The main regression indicates some relationship between the introduction of anti-helicopter legislation and decreased sightings. 

It's difficult to tell concretely with a small data set -- we can see the regression line driven upwards by forty- and fifty-sighting days. Human error also definitely plays a role. I'm using the quantified observations of helicopter enthusiasts as a stand-in for material that even my congresswoman can't access from the FAA. 

But the faceted data also indicates which 
